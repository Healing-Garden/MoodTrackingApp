...
const ForgotOtpScreen = ({ navigation, route }) => {
    ...
    const handleVerifyOTP = async () => {
        ...
        try {
            ...
            Alert.alert("Success", "OTP code verified successfully.");
    ...
    const handleResendOTP = async () => {
        ...
        try {
            ...
            Alert.alert("Error", "Failed to resend the code. Please try again later.");
        } finally {
            setLoading(false);
        }
    };
        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.brandSection}>
                    ...
                    <Text style={styles.subtitle}>Please enter the OTP code sent to {email}</Text>
                </View>
                    ...
                    <View style={styles.form}>
                        <View style={styles.inputGroup}>
                            ...
                            <View style={styles.inputWrapper}>
                                <MaterialIcons name="security" size={20} color={theme.colors.outline} style={styles.inputIcon} />
                                <TextInput
                                    style={styles.input}
                                    placeholder="123456"
