...
import { MaterialSymbolsOutlined } from 'react-native-material-symbols'; // Custom lib for Material Symbols
        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <TouchableOpacity style={styles.backCircle} onPress={() => navigation.goBack()}>
                    <MaterialSymbolsOutlined name="arrow_back" size={24} color={theme.colors.primaryFixed} />
                </TouchableOpacity>
                <Text style={styles.headerTitle}>Security Sanctuary</Text>
                <MaterialSymbolsOutlined name="shield" size={24} color={theme.colors.primaryFixed} />
            </View>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.heroSection}>
                    <View style={styles.heroIconContainer}>
                        <MaterialSymbolsOutlined name="lock_person" size={32} color={theme.colors.primaryContainer} />
                    </View>
                ...
                <View style={styles.options}>
                    ...
                    <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('ChangePin')}>
                        <View style={styles.cardLeft}>
                            <View style={[styles.cardIconBg, { backgroundColor: theme.colors.surfaceContainerHighest }]}>
                                <MaterialSymbolsOutlined name="password" size={22} color={theme.colors.primary} />
                            </View>
                            <View>
                        ...
                        <MaterialSymbolsOutlined name="chevron_right" size={24} color={theme.colors.outlineVariant} />
                    </TouchableOpacity>
                    ...
                    <View style={styles.card}>
                        <View style={styles.cardLeft}>
                            <View style={[styles.cardIconBg, { backgroundColor: 'rgba(154,225,255,0.3)' }]}>
                                <MaterialSymbolsOutlined name="verified_user" size={22} color={theme.colors.secondary} />
                            </View>
                            <View>
                    ...
                    <View style={styles.infoBanner}>
                        <MaterialSymbolsOutlined name="info" size={20} color={theme.colors.primary} />
                ...
                <View style={styles.quoteCard}>
                    ...
                    <View style={styles.quoteContent}>
                        <MaterialSymbolsOutlined name="eco" size={32} color={theme.colors.primary} />
